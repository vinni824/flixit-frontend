import { ADDLIST,REMOVELIST,LOGIN,SIGNUP,GENRES,MOVIEDATA,BANNERDATA,MYLIST,LOGOUT,SEARCHDATA,CONFIGURL } from "./actionType.js"
import axios from "axios";

import { Button, message } from 'antd';

const BASE_URL = "https://flixxit-k9acriuv3-anils-projects-2ee19758.vercel.app/api";
...
export const addToList=(params,successCallback,callback)=>{
    ...
    return async(dispatch)=>{
        ...
        try {
            const { data } = await axios.post(BASE_URL + `/users/add-to-watchlist`, params,{
                headers
            });
            successCallback(data)
...
export const removeFromList=(params,successCallback,callback)=>{
    ...
    return async(dispatch)=>{
        ...
        try {
            const { data } = await axios.post(BASE_URL + `/users/remove-from-watchlist`, params,{
                headers
            });
            successCallback(data)
...
export const updateProfile=(params,successCallback,callback)=>{
    ...
    return async(dispatch)=>{
        ...
        try {
            const { data } = await axios.patch(BASE_URL + `/users/update-profile`,params,{
                headers
            });
            successCallback(data)
